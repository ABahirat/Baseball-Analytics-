use lahman2016;
select distinct concat(m.nameFirst, " ", m.nameLast) as name, t.name as team, (b.H-b.2B-b.3B-b.HR)/(b.H) as 1Bprob, (b.2B)/(b.H) as 2Bprob, (b.3B)/(b.H) as 3Bprob, (b.HR)/(b.H) as HRprob, (b.H)/(b.AB) as BA from batting as b
